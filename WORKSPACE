...
go_repository(
    name = "com_github_webview_webview",
    importpath = "github.com/webview/webview",
    sum = "h1:z780M7mCrdt6KiICeW9SGirvQjxDlrVU+n99FO93nbI=",
    version = "v0.0.0-20210330151455-f540d88dde4e",
)

go_repository(
    name = "com_github_zserge_lorca",
    importpath = "github.com/zserge/lorca",
    sum = "h1:f/xBJ3D3ipcVRCcvN8XqZnpoKcOXV8I4vwqlFyw7ruc=",
    version = "v0.1.10",
)
